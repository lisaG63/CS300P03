...
public class DriverApplication extends PApplet {
  ...
  private KaleidoscopePen pens; // the pens that manages this application's drawing
   ...
   */
  public void setup() {
    pens = new KaleidoscopePen(this, 5);
  }
  ...
  public void draw() {
    ...
    pens.update(mouseX,mouseY,mousePressed,keyPressed?key:'\0');
  }
